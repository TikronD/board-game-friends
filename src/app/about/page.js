    ...
    <div className="about-container">
      <div className="about">
        ...
        <p className="text">
          ...
          to bring people together, create new connections, creativity, and
      ...
      <div className="about-track">
        <div className="slide-about">
          ...
          <h3>Edd</h3>
          <p className="biotext">
            My name is Edd, short for Edward, I am a parcifist, ex Herbal
            Essence model, part time coder other part board gamer. I have a
            passion for LARPing. I even made my own staff, it's beautiful. The
            other day Daniel came over to visit, when he lifted the staff over
            his head he looked like Aragorn with the power of Gandalf.
          </p>
        </div>
        <div className="slide-about">
          ...
          <h3>Jimmy</h3>
          <p className="biotext">
            I've met those guys on a bootcamp in Norwich. We coded this webpage
            together as a final project. I love playing video games in my free
            time, but started playing boardgames in my lunch break. My dream is
            to have long hair like Edd and a beard as full as Dan's, they are so
            handsome.
          </p>
        </div>
        <div className="slide-about">
          ...
          <p className="biotext">
            ...
            She had a lot of patience with me and I haven't flipped a table in
            ...
            are Wonderland War, Ark Nova and Apiary, give me a shout if you want
            a game...
          </p>
        </div>
        <div className="slide-about">
          ...
          <p className="biotext">
            ...
            at every game we play, he's my idol. I want to be like you Dan, why
            can't I be like you?
          </p>
        </div>
      </div>
