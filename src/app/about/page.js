  ...
  return (
    <div className="about-container">
      <div className="about">
        ...
        <p className="text">
          Welcome to Board Game Friends, the ultimate destination for board game
          enthusiasts of all levels! Born from a passion for tabletop gaming and
          a desire to connect players with a wide range of board games, from
          timeless classics to the latest hits, our marketplace is designed to
          cater to every taste and interest.
        </p>
        <h2 id="mission">Our Mission</h2>
        <p className="text">
          At Board Game Friends, our mission is simple: to provide a
          comprehensive, user-friendly platform where gamers can discover, buy,
          and sell board games with ease. We believe in the power of board games
          to bring people together, fostering connections, creativity, and
